                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <div class="bs-example" data-example-id="simple-jumbotron">
                    <div class="jumbotron">
                      ...
                      <p style="font-size: 18px;text-align: justify;">Aplikasi Pengelolaan Presensi adalah sebuah sistem aplikasi yang dapat digunakan untuk keperluan pencatatan kehadiran / ketidakhadiran siswa dengan tambahan fitur Whatsapp Gateway yang dapat mengirim pesan kepada orang tua ketika siswa dicatat dakam kondisi tertentu (Alfa). Selain itu pada aplikasi ini juga dilengkapi fitur untuk melihat laporan presensi siswa dalam kurun waktu tertentu ( per-hari, per-bulan, per-semester, per-jadwal pelajaran). Dua fitur tambahan tersebut hanya terdapat di hak akses sebagai wali kelas.
                    </div>
                  </div>
                </div>
