      ...
      <div class="container">
          ...
          <div class="row tile_count">
            ...
            <a href="<?php echo base_url('admin/daftar_User') ?>">
              <span class="count_top" style="color: #218c74"><i class="fa fa-user"></i> Total Pengguna</span>
            </a>
            ...
            <a href="<?php echo base_url('admin/daftar_guru') ?>">
              <span class="count_top" style="color: #218c74"><i class="fa fa-clock-o"></i>Total Guru</span>
            </a>
            ...
            <div class="col-md-3 col-sm-4 col-xs-6 tile_stats_count">
           <a href="<?php echo base_url('admin/daftar_rombel') ?>">
              <span class="count_top" style="color: #218c74"><i class="fa fa-user"></i> Total Wali Kelas</span>
            </a>
           ...
           <a href="<?php echo base_url('admin/daftar_siswa') ?>">
              <span class="count_top" style="color: #218c74"><i class="fa fa-user"></i> Total Siswa</span>
            </a>
          ...
          <div class="dashboard_graph">
                ...
                <div class="col-md-9 col-sm-9 col-xs-12">
                  <div class="bs-example" data-example-id="simple-jumbotron">
                    <div class="jumbotron">
                      <h1 style="color: #218c74">Hello, Admin</h1>
          ...
          <div class="x_panel">
              ...
              <div class="x_panel tile fixed_height_320">
                <div class="x_title">
                  ...
                  <center><h2></nav>DAFTAR SISWA ALFA HARI INI</h2></center>
