                <div class="x_panel">
                <div class="container">
                  <center><h2 style="color: #218c74 "> FORM INPUT DATA SISWA </h2></center> <hr>
                  <br> 
              ...
              <?= $this->session->flashdata('message2'); ?>
                  ...
                  <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          ...
                          <input id="nama_siswa" class="form-control col-md-7 col-xs-12" name="nama_siswa" placeholder="masukkan nama siswa"  pattern="[A-Za-z ]+"  required type="text" value="<?php echo set_value('nama_siswa'); ?>" >
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="nipd" name="nipd" placeholder="masukkan nipd siswa 4 kar" required="required" class="form-control col-md-7 col-xs-12" pattern="[0-9]{4}" value="<?php echo set_value('nipd'); ?>">
                        </div>
                      </div>
                    ...
                    <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="nisn" name="nisn" placeholder="masukkan nisn siswa 8 kar"  required="required" pattern="[0-9]{8}" class="form-control col-md-7 col-xs-12"  value="<?php echo set_value('nisn'); ?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="tempat_lahir" name="tempat_lahir"placeholder="masukkan tempat lahir siswa"  required="required" data-validate-minmax="10,100" class="form-control col-md-7 col-xs-12" pattern="[A-Za-z ]+" value="<?php echo set_value('tempat_lahir'); ?>">
                        </div>
                      </div>
                      ...
                      <div class="item form-group">
                       ...
                       <div class="col-md-3 col-sm-6 col-xs-12">
                        <div class='input-group date' id='myDatepicker4' name="tgl_lahir">
                            <input type='text' class="form-control" name="tgl_lahir" value="12-12-2008" readonly="readonly" />
                     ...
                     <div class="item form-group">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          ...
                          name="RT" placeholder="masukkan RT "  required="required" pattern="[0-9]{1,2}" type="text" value="<?php echo set_value('RT'); ?>">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          ...
                          name="RW" placeholder="masukkan RW "  required="required" pattern="[0-9]{1,2}"  type="text" value="<?php echo set_value('RW'); ?>">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          ...
                          name="dusun" pattern="[A-Za-z ]+"  required="required" placeholder="masukkan dusun "  type="text" value="<?php echo set_value('dusun'); ?>">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          ...
                          name="kelurahan" pattern="[A-Za-z ]+"  required="required" placeholder="masukkan kelurahan "  type="text" value="<?php echo set_value('kelurahan'); ?>">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          ...
                          name="kecamatan"  required="required" placeholder="masukkan kecamatan" pattern="[A-Za-z ]+" type="text" value="<?php echo set_value('kecamatan'); ?>">
                    ...
                    <div class="item form-group">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                          ...
                          name="kode_pos" placeholder="masukkan kode_pos" pattern="[0-9]{5}" type="text" value="<?php echo set_value('kode_pos'); ?>">
                    ...
                    <div class="item form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="no_hp_ortu">NO HP ORANG TUA <span class="required">* <br> format : 62 </span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
